...
80102088:	68 82 79 10 80       	push   $0x80107982
...
80103824:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
80103827:	c7 40 14 f7 58 10 80 	movl   $0x801058f7,0x14(%eax)
  p->context = (struct context*)sp;
...
801041fb:	68 93 7e 10 80       	push   $0x80107e93
...
80104c04:	68 78 79 10 80       	push   $0x80107978
...
80104c1c:	68 77 79 10 80       	push   $0x80107977
...
80104c31:	68 6b 79 10 80       	push   $0x8010796b
...
80104c4f:	68 7a 79 10 80       	push   $0x8010797a
80104c54:	e8 27 b7 ff ff       	call   80100380 <panic>
    panic("create: ialloc");
80104c59:	83 ec 0c             	sub    $0xc,%esp
80104c5c:	68 5c 79 10 80       	push   $0x8010795c
...
8010505d:	58                   	pop    %eax
8010505e:	5a                   	pop    %edx
8010505f:	68 78 79 10 80       	push   $0x80107978
...
80105078:	68 77 79 10 80       	push   $0x80107977
...
80105845:	8d 85 f8 fc ff ff    	lea    -0x308(%ebp),%eax
  argptr(1, (void*)&size, sizeof(size));

  char text[] = "Hello this is first lab: \n\
8010584b:	8d bd 04 fd ff ff    	lea    -0x2fc(%ebp),%edi
80105851:	be c0 79 10 80       	mov    $0x801079c0,%esi
{
80105856:	81 ec 04 03 00 00    	sub    $0x304,%esp
  argptr(0, (void*)&buf, sizeof(buf));
8010585c:	6a 04                	push   $0x4
8010585e:	50                   	push   %eax
8010585f:	6a 00                	push   $0x0
80105861:	e8 0a f1 ff ff       	call   80104970 <argptr>
  argptr(1, (void*)&size, sizeof(size));
80105866:	83 c4 0c             	add    $0xc,%esp
80105869:	8d 85 fc fc ff ff    	lea    -0x304(%ebp),%eax
8010586f:	6a 04                	push   $0x4
80105871:	50                   	push   %eax
80105872:	6a 01                	push   $0x1
80105874:	e8 f7 f0 ff ff       	call   80104970 <argptr>
  char text[] = "Hello this is first lab: \n\
80105879:	8b 15 c0 79 10 80    	mov    0x801079c0,%edx
8010587f:	8d 85 02 fd ff ff    	lea    -0x2fe(%ebp),%eax
                     O    .   .   . . .      O\n\
                    O     .   .       .       O\n\
                   O      . . .   . . .        O\n\
                  O                             O\n\
...
80105885:	83 c4 10             	add    $0x10,%esp
  char text[] = "Hello this is first lab: \n\
80105888:	89 c1                	mov    %eax,%ecx
8010588a:	29 f9                	sub    %edi,%ecx
8010588c:	89 95 02 fd ff ff    	mov    %edx,-0x2fe(%ebp)
80105892:	8b 15 b2 7c 10 80    	mov    0x80107cb2,%edx
80105898:	29 ce                	sub    %ecx,%esi
8010589a:	81 c1 f6 02 00 00    	add    $0x2f6,%ecx
801058a0:	89 55 f4             	mov    %edx,-0xc(%ebp)
801058a3:	c1 e9 02             	shr    $0x2,%ecx
801058a6:	f3 a5                	rep movsl %ds:(%esi),%es:(%edi)
  if(sizeof(text)>size)
801058a8:	8b 95 fc fc ff ff    	mov    -0x304(%ebp),%edx
801058ae:	81 fa f5 02 00 00    	cmp    $0x2f5,%edx
801058b4:	76 22                	jbe    801058d8 <sys_draw+0x98>
    return -1;
...
801058bb:	ff b5 f8 fc ff ff    	push   -0x308(%ebp)
801058c1:	e8 fa ee ff ff       	call   801047c0 <strncpy>
  return sizeof(text);
801058c6:	83 c4 10             	add    $0x10,%esp
801058c9:	b8 f6 02 00 00       	mov    $0x2f6,%eax
}
...
801058dd:	eb ef                	jmp    801058ce <sys_draw+0x8e>
...
801058e0:	06                   	push   %es
  pushl %fs
801058e1:	0f a0                	push   %fs
  pushl %gs
801058e3:	0f a8                	push   %gs
  pushal
801058e5:	60                   	pusha  
  
  # Set up data segments.
  movw $(SEG_KDATA<<3), %ax
801058e6:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
801058ea:	8e d8                	mov    %eax,%ds
  movw %ax, %es
801058ec:	8e c0                	mov    %eax,%es

  # Call trap(tf), where tf=%esp
  pushl %esp
801058ee:	54                   	push   %esp
  call trap
801058ef:	e8 cc 00 00 00       	call   801059c0 <trap>
  addl $4, %esp
801058f4:	83 c4 04             	add    $0x4,%esp
...
801058f7:	61                   	popa   
  popl %gs
801058f8:	0f a9                	pop    %gs
  popl %fs
801058fa:	0f a1                	pop    %fs
  popl %es
801058fc:	07                   	pop    %es
  popl %ds
801058fd:	1f                   	pop    %ds
  addl $0x8, %esp  # trapno and errcode
801058fe:	83 c4 08             	add    $0x8,%esp
  iret
80105901:	cf                   	iret   
80105902:	66 90                	xchg   %ax,%ax
80105904:	66 90                	xchg   %ax,%ax
...
8010595e:	00 00 ef 
  initlock(&tickslock, "time");
80105961:	68 b6 7c 10 80       	push   $0x80107cb6
...
801059e4:	ff 24 85 5c 7d 10 80 	jmp    *-0x7fef82a4(,%eax,4)
...
80105ac5:	68 18 7d 10 80       	push   $0x80107d18
...
80105b17:	68 c0 7c 10 80       	push   $0x80107cc0
...
80105b55:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
80105b58:	e8 03 ef ff ff       	call   80104a60 <syscall>
    if(myproc()->killed)
...
80105bd5:	e8 c6 e9 ff ff       	call   801045a0 <acquire>
      wakeup(&ticks);
...
80105bf4:	e8 47 e9 ff ff       	call   80104540 <release>
...
80105c33:	68 e4 7c 10 80       	push   $0x80107ce4
80105c38:	e8 63 aa ff ff       	call   801006a0 <cprintf>
      panic("trap");
80105c3d:	83 c4 14             	add    $0x14,%esp
80105c40:	68 bb 7c 10 80       	push   $0x80107cbb
...
80105cec:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105cef:	bf dc 7d 10 80       	mov    $0x80107ddc,%edi
...
80105dd7:	6a 00                	push   $0x0
  jmp alltraps
80105dd9:	e9 01 fb ff ff       	jmp    801058df <alltraps>
...
80105de0:	6a 01                	push   $0x1
  jmp alltraps
80105de2:	e9 f8 fa ff ff       	jmp    801058df <alltraps>
...
80105de9:	6a 02                	push   $0x2
  jmp alltraps
80105deb:	e9 ef fa ff ff       	jmp    801058df <alltraps>
...
80105df2:	6a 03                	push   $0x3
  jmp alltraps
80105df4:	e9 e6 fa ff ff       	jmp    801058df <alltraps>
...
80105dfb:	6a 04                	push   $0x4
  jmp alltraps
80105dfd:	e9 dd fa ff ff       	jmp    801058df <alltraps>
...
80105e04:	6a 05                	push   $0x5
  jmp alltraps
80105e06:	e9 d4 fa ff ff       	jmp    801058df <alltraps>
...
80105e0d:	6a 06                	push   $0x6
  jmp alltraps
80105e0f:	e9 cb fa ff ff       	jmp    801058df <alltraps>
...
80105e16:	6a 07                	push   $0x7
  jmp alltraps
80105e18:	e9 c2 fa ff ff       	jmp    801058df <alltraps>
...
80105e1d:	6a 08                	push   $0x8
  jmp alltraps
80105e1f:	e9 bb fa ff ff       	jmp    801058df <alltraps>
...
80105e26:	6a 09                	push   $0x9
  jmp alltraps
80105e28:	e9 b2 fa ff ff       	jmp    801058df <alltraps>
...
80105e2d:	6a 0a                	push   $0xa
  jmp alltraps
80105e2f:	e9 ab fa ff ff       	jmp    801058df <alltraps>
...
80105e34:	6a 0b                	push   $0xb
  jmp alltraps
80105e36:	e9 a4 fa ff ff       	jmp    801058df <alltraps>
...
80105e3b:	6a 0c                	push   $0xc
  jmp alltraps
80105e3d:	e9 9d fa ff ff       	jmp    801058df <alltraps>
...
80105e42:	6a 0d                	push   $0xd
  jmp alltraps
80105e44:	e9 96 fa ff ff       	jmp    801058df <alltraps>
...
80105e49:	6a 0e                	push   $0xe
  jmp alltraps
80105e4b:	e9 8f fa ff ff       	jmp    801058df <alltraps>
...
80105e52:	6a 0f                	push   $0xf
  jmp alltraps
80105e54:	e9 86 fa ff ff       	jmp    801058df <alltraps>
...
80105e5b:	6a 10                	push   $0x10
  jmp alltraps
80105e5d:	e9 7d fa ff ff       	jmp    801058df <alltraps>
...
80105e62:	6a 11                	push   $0x11
  jmp alltraps
80105e64:	e9 76 fa ff ff       	jmp    801058df <alltraps>
...
80105e6b:	6a 12                	push   $0x12
  jmp alltraps
80105e6d:	e9 6d fa ff ff       	jmp    801058df <alltraps>
...
80105e74:	6a 13                	push   $0x13
  jmp alltraps
80105e76:	e9 64 fa ff ff       	jmp    801058df <alltraps>
...
80105e7d:	6a 14                	push   $0x14
  jmp alltraps
80105e7f:	e9 5b fa ff ff       	jmp    801058df <alltraps>
...
80105e86:	6a 15                	push   $0x15
  jmp alltraps
80105e88:	e9 52 fa ff ff       	jmp    801058df <alltraps>
...
80105e8f:	6a 16                	push   $0x16
  jmp alltraps
80105e91:	e9 49 fa ff ff       	jmp    801058df <alltraps>
...
80105e98:	6a 17                	push   $0x17
  jmp alltraps
80105e9a:	e9 40 fa ff ff       	jmp    801058df <alltraps>
...
80105ea1:	6a 18                	push   $0x18
  jmp alltraps
80105ea3:	e9 37 fa ff ff       	jmp    801058df <alltraps>
...
80105eaa:	6a 19                	push   $0x19
  jmp alltraps
80105eac:	e9 2e fa ff ff       	jmp    801058df <alltraps>
...
80105eb3:	6a 1a                	push   $0x1a
  jmp alltraps
80105eb5:	e9 25 fa ff ff       	jmp    801058df <alltraps>
...
80105ebc:	6a 1b                	push   $0x1b
  jmp alltraps
80105ebe:	e9 1c fa ff ff       	jmp    801058df <alltraps>
...
80105ec5:	6a 1c                	push   $0x1c
  jmp alltraps
80105ec7:	e9 13 fa ff ff       	jmp    801058df <alltraps>
...
80105ece:	6a 1d                	push   $0x1d
  jmp alltraps
80105ed0:	e9 0a fa ff ff       	jmp    801058df <alltraps>
...
80105ed7:	6a 1e                	push   $0x1e
  jmp alltraps
80105ed9:	e9 01 fa ff ff       	jmp    801058df <alltraps>
...
80105ee0:	6a 1f                	push   $0x1f
  jmp alltraps
80105ee2:	e9 f8 f9 ff ff       	jmp    801058df <alltraps>
...
80105ee9:	6a 20                	push   $0x20
  jmp alltraps
80105eeb:	e9 ef f9 ff ff       	jmp    801058df <alltraps>
...
80105ef2:	6a 21                	push   $0x21
  jmp alltraps
80105ef4:	e9 e6 f9 ff ff       	jmp    801058df <alltraps>
...
80105efb:	6a 22                	push   $0x22
  jmp alltraps
80105efd:	e9 dd f9 ff ff       	jmp    801058df <alltraps>
...
80105f04:	6a 23                	push   $0x23
  jmp alltraps
80105f06:	e9 d4 f9 ff ff       	jmp    801058df <alltraps>
...
80105f0d:	6a 24                	push   $0x24
  jmp alltraps
80105f0f:	e9 cb f9 ff ff       	jmp    801058df <alltraps>
...
80105f16:	6a 25                	push   $0x25
  jmp alltraps
80105f18:	e9 c2 f9 ff ff       	jmp    801058df <alltraps>
...
80105f1f:	6a 26                	push   $0x26
  jmp alltraps
80105f21:	e9 b9 f9 ff ff       	jmp    801058df <alltraps>
...
80105f28:	6a 27                	push   $0x27
  jmp alltraps
80105f2a:	e9 b0 f9 ff ff       	jmp    801058df <alltraps>
...
80105f31:	6a 28                	push   $0x28
  jmp alltraps
80105f33:	e9 a7 f9 ff ff       	jmp    801058df <alltraps>
...
80105f3a:	6a 29                	push   $0x29
  jmp alltraps
80105f3c:	e9 9e f9 ff ff       	jmp    801058df <alltraps>
...
80105f43:	6a 2a                	push   $0x2a
  jmp alltraps
80105f45:	e9 95 f9 ff ff       	jmp    801058df <alltraps>
...
80105f4c:	6a 2b                	push   $0x2b
  jmp alltraps
80105f4e:	e9 8c f9 ff ff       	jmp    801058df <alltraps>
...
80105f55:	6a 2c                	push   $0x2c
  jmp alltraps
80105f57:	e9 83 f9 ff ff       	jmp    801058df <alltraps>
...
80105f5e:	6a 2d                	push   $0x2d
  jmp alltraps
80105f60:	e9 7a f9 ff ff       	jmp    801058df <alltraps>
...
80105f67:	6a 2e                	push   $0x2e
  jmp alltraps
80105f69:	e9 71 f9 ff ff       	jmp    801058df <alltraps>
...
80105f70:	6a 2f                	push   $0x2f
  jmp alltraps
80105f72:	e9 68 f9 ff ff       	jmp    801058df <alltraps>
...
80105f79:	6a 30                	push   $0x30
  jmp alltraps
80105f7b:	e9 5f f9 ff ff       	jmp    801058df <alltraps>
...
80105f82:	6a 31                	push   $0x31
  jmp alltraps
80105f84:	e9 56 f9 ff ff       	jmp    801058df <alltraps>
...
80105f8b:	6a 32                	push   $0x32
  jmp alltraps
80105f8d:	e9 4d f9 ff ff       	jmp    801058df <alltraps>
...
80105f94:	6a 33                	push   $0x33
  jmp alltraps
80105f96:	e9 44 f9 ff ff       	jmp    801058df <alltraps>
...
80105f9d:	6a 34                	push   $0x34
  jmp alltraps
80105f9f:	e9 3b f9 ff ff       	jmp    801058df <alltraps>
...
80105fa6:	6a 35                	push   $0x35
  jmp alltraps
80105fa8:	e9 32 f9 ff ff       	jmp    801058df <alltraps>
...
80105faf:	6a 36                	push   $0x36
  jmp alltraps
80105fb1:	e9 29 f9 ff ff       	jmp    801058df <alltraps>
...
80105fb8:	6a 37                	push   $0x37
  jmp alltraps
80105fba:	e9 20 f9 ff ff       	jmp    801058df <alltraps>
...
80105fc1:	6a 38                	push   $0x38
  jmp alltraps
80105fc3:	e9 17 f9 ff ff       	jmp    801058df <alltraps>
...
80105fca:	6a 39                	push   $0x39
  jmp alltraps
80105fcc:	e9 0e f9 ff ff       	jmp    801058df <alltraps>
...
80105fd3:	6a 3a                	push   $0x3a
  jmp alltraps
80105fd5:	e9 05 f9 ff ff       	jmp    801058df <alltraps>
...
80105fdc:	6a 3b                	push   $0x3b
  jmp alltraps
80105fde:	e9 fc f8 ff ff       	jmp    801058df <alltraps>
...
80105fe5:	6a 3c                	push   $0x3c
  jmp alltraps
80105fe7:	e9 f3 f8 ff ff       	jmp    801058df <alltraps>
...
80105fee:	6a 3d                	push   $0x3d
  jmp alltraps
80105ff0:	e9 ea f8 ff ff       	jmp    801058df <alltraps>
...
80105ff7:	6a 3e                	push   $0x3e
  jmp alltraps
80105ff9:	e9 e1 f8 ff ff       	jmp    801058df <alltraps>
...
80106000:	6a 3f                	push   $0x3f
  jmp alltraps
80106002:	e9 d8 f8 ff ff       	jmp    801058df <alltraps>
...
80106009:	6a 40                	push   $0x40
  jmp alltraps
8010600b:	e9 cf f8 ff ff       	jmp    801058df <alltraps>
...
80106012:	6a 41                	push   $0x41
  jmp alltraps
80106014:	e9 c6 f8 ff ff       	jmp    801058df <alltraps>
...
8010601b:	6a 42                	push   $0x42
  jmp alltraps
8010601d:	e9 bd f8 ff ff       	jmp    801058df <alltraps>
...
80106024:	6a 43                	push   $0x43
  jmp alltraps
80106026:	e9 b4 f8 ff ff       	jmp    801058df <alltraps>
...
8010602d:	6a 44                	push   $0x44
  jmp alltraps
8010602f:	e9 ab f8 ff ff       	jmp    801058df <alltraps>
...
80106036:	6a 45                	push   $0x45
  jmp alltraps
80106038:	e9 a2 f8 ff ff       	jmp    801058df <alltraps>
...
8010603f:	6a 46                	push   $0x46
  jmp alltraps
80106041:	e9 99 f8 ff ff       	jmp    801058df <alltraps>
...
80106048:	6a 47                	push   $0x47
  jmp alltraps
8010604a:	e9 90 f8 ff ff       	jmp    801058df <alltraps>
...
80106051:	6a 48                	push   $0x48
  jmp alltraps
80106053:	e9 87 f8 ff ff       	jmp    801058df <alltraps>
...
8010605a:	6a 49                	push   $0x49
  jmp alltraps
8010605c:	e9 7e f8 ff ff       	jmp    801058df <alltraps>
...
80106063:	6a 4a                	push   $0x4a
  jmp alltraps
80106065:	e9 75 f8 ff ff       	jmp    801058df <alltraps>
...
8010606c:	6a 4b                	push   $0x4b
  jmp alltraps
8010606e:	e9 6c f8 ff ff       	jmp    801058df <alltraps>
...
80106075:	6a 4c                	push   $0x4c
  jmp alltraps
80106077:	e9 63 f8 ff ff       	jmp    801058df <alltraps>
...
8010607e:	6a 4d                	push   $0x4d
  jmp alltraps
80106080:	e9 5a f8 ff ff       	jmp    801058df <alltraps>
...
80106087:	6a 4e                	push   $0x4e
  jmp alltraps
80106089:	e9 51 f8 ff ff       	jmp    801058df <alltraps>
...
80106090:	6a 4f                	push   $0x4f
  jmp alltraps
80106092:	e9 48 f8 ff ff       	jmp    801058df <alltraps>
...
80106099:	6a 50                	push   $0x50
  jmp alltraps
8010609b:	e9 3f f8 ff ff       	jmp    801058df <alltraps>
...
801060a2:	6a 51                	push   $0x51
  jmp alltraps
801060a4:	e9 36 f8 ff ff       	jmp    801058df <alltraps>
...
801060ab:	6a 52                	push   $0x52
  jmp alltraps
801060ad:	e9 2d f8 ff ff       	jmp    801058df <alltraps>
...
801060b4:	6a 53                	push   $0x53
  jmp alltraps
801060b6:	e9 24 f8 ff ff       	jmp    801058df <alltraps>
...
801060bd:	6a 54                	push   $0x54
  jmp alltraps
801060bf:	e9 1b f8 ff ff       	jmp    801058df <alltraps>
...
801060c6:	6a 55                	push   $0x55
  jmp alltraps
801060c8:	e9 12 f8 ff ff       	jmp    801058df <alltraps>
...
801060cf:	6a 56                	push   $0x56
  jmp alltraps
801060d1:	e9 09 f8 ff ff       	jmp    801058df <alltraps>
...
801060d8:	6a 57                	push   $0x57
  jmp alltraps
801060da:	e9 00 f8 ff ff       	jmp    801058df <alltraps>
...
801060e1:	6a 58                	push   $0x58
  jmp alltraps
801060e3:	e9 f7 f7 ff ff       	jmp    801058df <alltraps>
...
801060ea:	6a 59                	push   $0x59
  jmp alltraps
801060ec:	e9 ee f7 ff ff       	jmp    801058df <alltraps>
...
801060f3:	6a 5a                	push   $0x5a
  jmp alltraps
801060f5:	e9 e5 f7 ff ff       	jmp    801058df <alltraps>
...
801060fc:	6a 5b                	push   $0x5b
  jmp alltraps
801060fe:	e9 dc f7 ff ff       	jmp    801058df <alltraps>
...
80106105:	6a 5c                	push   $0x5c
  jmp alltraps
80106107:	e9 d3 f7 ff ff       	jmp    801058df <alltraps>
...
8010610e:	6a 5d                	push   $0x5d
  jmp alltraps
80106110:	e9 ca f7 ff ff       	jmp    801058df <alltraps>
...
80106117:	6a 5e                	push   $0x5e
  jmp alltraps
80106119:	e9 c1 f7 ff ff       	jmp    801058df <alltraps>
...
80106120:	6a 5f                	push   $0x5f
  jmp alltraps
80106122:	e9 b8 f7 ff ff       	jmp    801058df <alltraps>
...
80106129:	6a 60                	push   $0x60
  jmp alltraps
8010612b:	e9 af f7 ff ff       	jmp    801058df <alltraps>
...
80106132:	6a 61                	push   $0x61
  jmp alltraps
80106134:	e9 a6 f7 ff ff       	jmp    801058df <alltraps>
...
8010613b:	6a 62                	push   $0x62
  jmp alltraps
8010613d:	e9 9d f7 ff ff       	jmp    801058df <alltraps>
...
80106144:	6a 63                	push   $0x63
  jmp alltraps
80106146:	e9 94 f7 ff ff       	jmp    801058df <alltraps>
...
8010614d:	6a 64                	push   $0x64
  jmp alltraps
8010614f:	e9 8b f7 ff ff       	jmp    801058df <alltraps>
...
80106156:	6a 65                	push   $0x65
  jmp alltraps
80106158:	e9 82 f7 ff ff       	jmp    801058df <alltraps>
...
8010615f:	6a 66                	push   $0x66
  jmp alltraps
80106161:	e9 79 f7 ff ff       	jmp    801058df <alltraps>
...
80106168:	6a 67                	push   $0x67
  jmp alltraps
8010616a:	e9 70 f7 ff ff       	jmp    801058df <alltraps>
...
80106171:	6a 68                	push   $0x68
  jmp alltraps
80106173:	e9 67 f7 ff ff       	jmp    801058df <alltraps>
...
8010617a:	6a 69                	push   $0x69
  jmp alltraps
8010617c:	e9 5e f7 ff ff       	jmp    801058df <alltraps>
...
80106183:	6a 6a                	push   $0x6a
  jmp alltraps
80106185:	e9 55 f7 ff ff       	jmp    801058df <alltraps>
...
8010618c:	6a 6b                	push   $0x6b
  jmp alltraps
8010618e:	e9 4c f7 ff ff       	jmp    801058df <alltraps>
...
80106195:	6a 6c                	push   $0x6c
  jmp alltraps
80106197:	e9 43 f7 ff ff       	jmp    801058df <alltraps>
...
8010619e:	6a 6d                	push   $0x6d
  jmp alltraps
801061a0:	e9 3a f7 ff ff       	jmp    801058df <alltraps>
...
801061a7:	6a 6e                	push   $0x6e
  jmp alltraps
801061a9:	e9 31 f7 ff ff       	jmp    801058df <alltraps>
...
801061b0:	6a 6f                	push   $0x6f
  jmp alltraps
801061b2:	e9 28 f7 ff ff       	jmp    801058df <alltraps>
...
801061b9:	6a 70                	push   $0x70
  jmp alltraps
801061bb:	e9 1f f7 ff ff       	jmp    801058df <alltraps>
...
801061c2:	6a 71                	push   $0x71
  jmp alltraps
801061c4:	e9 16 f7 ff ff       	jmp    801058df <alltraps>
...
801061cb:	6a 72                	push   $0x72
  jmp alltraps
801061cd:	e9 0d f7 ff ff       	jmp    801058df <alltraps>
...
801061d4:	6a 73                	push   $0x73
  jmp alltraps
801061d6:	e9 04 f7 ff ff       	jmp    801058df <alltraps>
...
801061dd:	6a 74                	push   $0x74
  jmp alltraps
801061df:	e9 fb f6 ff ff       	jmp    801058df <alltraps>
...
801061e6:	6a 75                	push   $0x75
  jmp alltraps
801061e8:	e9 f2 f6 ff ff       	jmp    801058df <alltraps>
...
801061ef:	6a 76                	push   $0x76
  jmp alltraps
801061f1:	e9 e9 f6 ff ff       	jmp    801058df <alltraps>
...
801061f8:	6a 77                	push   $0x77
  jmp alltraps
801061fa:	e9 e0 f6 ff ff       	jmp    801058df <alltraps>
...
80106201:	6a 78                	push   $0x78
  jmp alltraps
80106203:	e9 d7 f6 ff ff       	jmp    801058df <alltraps>
...
8010620a:	6a 79                	push   $0x79
  jmp alltraps
8010620c:	e9 ce f6 ff ff       	jmp    801058df <alltraps>
...
80106213:	6a 7a                	push   $0x7a
  jmp alltraps
80106215:	e9 c5 f6 ff ff       	jmp    801058df <alltraps>
...
8010621c:	6a 7b                	push   $0x7b
  jmp alltraps
8010621e:	e9 bc f6 ff ff       	jmp    801058df <alltraps>
...
80106225:	6a 7c                	push   $0x7c
  jmp alltraps
80106227:	e9 b3 f6 ff ff       	jmp    801058df <alltraps>
...
8010622e:	6a 7d                	push   $0x7d
  jmp alltraps
80106230:	e9 aa f6 ff ff       	jmp    801058df <alltraps>
...
80106237:	6a 7e                	push   $0x7e
  jmp alltraps
80106239:	e9 a1 f6 ff ff       	jmp    801058df <alltraps>
...
80106240:	6a 7f                	push   $0x7f
  jmp alltraps
80106242:	e9 98 f6 ff ff       	jmp    801058df <alltraps>
...
80106249:	68 80 00 00 00       	push   $0x80
  jmp alltraps
8010624e:	e9 8c f6 ff ff       	jmp    801058df <alltraps>
...
80106255:	68 81 00 00 00       	push   $0x81
  jmp alltraps
8010625a:	e9 80 f6 ff ff       	jmp    801058df <alltraps>
...
80106261:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80106266:	e9 74 f6 ff ff       	jmp    801058df <alltraps>
...
8010626d:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80106272:	e9 68 f6 ff ff       	jmp    801058df <alltraps>
...
80106279:	68 84 00 00 00       	push   $0x84
  jmp alltraps
8010627e:	e9 5c f6 ff ff       	jmp    801058df <alltraps>
...
80106285:	68 85 00 00 00       	push   $0x85
  jmp alltraps
8010628a:	e9 50 f6 ff ff       	jmp    801058df <alltraps>
...
80106291:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80106296:	e9 44 f6 ff ff       	jmp    801058df <alltraps>
...
8010629d:	68 87 00 00 00       	push   $0x87
  jmp alltraps
801062a2:	e9 38 f6 ff ff       	jmp    801058df <alltraps>
...
801062a9:	68 88 00 00 00       	push   $0x88
  jmp alltraps
801062ae:	e9 2c f6 ff ff       	jmp    801058df <alltraps>
...
801062b5:	68 89 00 00 00       	push   $0x89
  jmp alltraps
801062ba:	e9 20 f6 ff ff       	jmp    801058df <alltraps>
...
801062c1:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
801062c6:	e9 14 f6 ff ff       	jmp    801058df <alltraps>
...
801062cd:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
801062d2:	e9 08 f6 ff ff       	jmp    801058df <alltraps>
...
801062d9:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
801062de:	e9 fc f5 ff ff       	jmp    801058df <alltraps>
...
801062e5:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
801062ea:	e9 f0 f5 ff ff       	jmp    801058df <alltraps>
...
801062f1:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
801062f6:	e9 e4 f5 ff ff       	jmp    801058df <alltraps>
...
801062fd:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80106302:	e9 d8 f5 ff ff       	jmp    801058df <alltraps>
...
80106309:	68 90 00 00 00       	push   $0x90
  jmp alltraps
8010630e:	e9 cc f5 ff ff       	jmp    801058df <alltraps>
...
80106315:	68 91 00 00 00       	push   $0x91
  jmp alltraps
8010631a:	e9 c0 f5 ff ff       	jmp    801058df <alltraps>
...
80106321:	68 92 00 00 00       	push   $0x92
  jmp alltraps
80106326:	e9 b4 f5 ff ff       	jmp    801058df <alltraps>
...
8010632d:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80106332:	e9 a8 f5 ff ff       	jmp    801058df <alltraps>
...
80106339:	68 94 00 00 00       	push   $0x94
  jmp alltraps
8010633e:	e9 9c f5 ff ff       	jmp    801058df <alltraps>
...
80106345:	68 95 00 00 00       	push   $0x95
  jmp alltraps
8010634a:	e9 90 f5 ff ff       	jmp    801058df <alltraps>
...
80106351:	68 96 00 00 00       	push   $0x96
  jmp alltraps
80106356:	e9 84 f5 ff ff       	jmp    801058df <alltraps>
...
8010635d:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80106362:	e9 78 f5 ff ff       	jmp    801058df <alltraps>
...
80106369:	68 98 00 00 00       	push   $0x98
  jmp alltraps
8010636e:	e9 6c f5 ff ff       	jmp    801058df <alltraps>
...
80106375:	68 99 00 00 00       	push   $0x99
  jmp alltraps
8010637a:	e9 60 f5 ff ff       	jmp    801058df <alltraps>
...
80106381:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80106386:	e9 54 f5 ff ff       	jmp    801058df <alltraps>
...
8010638d:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80106392:	e9 48 f5 ff ff       	jmp    801058df <alltraps>
...
80106399:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
8010639e:	e9 3c f5 ff ff       	jmp    801058df <alltraps>
...
801063a5:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
801063aa:	e9 30 f5 ff ff       	jmp    801058df <alltraps>
...
801063b1:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
801063b6:	e9 24 f5 ff ff       	jmp    801058df <alltraps>
...
801063bd:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
801063c2:	e9 18 f5 ff ff       	jmp    801058df <alltraps>
...
801063c9:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
801063ce:	e9 0c f5 ff ff       	jmp    801058df <alltraps>
...
801063d5:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
801063da:	e9 00 f5 ff ff       	jmp    801058df <alltraps>
...
801063e1:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
801063e6:	e9 f4 f4 ff ff       	jmp    801058df <alltraps>
...
801063ed:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
801063f2:	e9 e8 f4 ff ff       	jmp    801058df <alltraps>
...
801063f9:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
801063fe:	e9 dc f4 ff ff       	jmp    801058df <alltraps>
...
80106405:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
8010640a:	e9 d0 f4 ff ff       	jmp    801058df <alltraps>
...
80106411:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
80106416:	e9 c4 f4 ff ff       	jmp    801058df <alltraps>
...
8010641d:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
80106422:	e9 b8 f4 ff ff       	jmp    801058df <alltraps>
...
80106429:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
8010642e:	e9 ac f4 ff ff       	jmp    801058df <alltraps>
...
80106435:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
8010643a:	e9 a0 f4 ff ff       	jmp    801058df <alltraps>
...
80106441:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
80106446:	e9 94 f4 ff ff       	jmp    801058df <alltraps>
...
8010644d:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80106452:	e9 88 f4 ff ff       	jmp    801058df <alltraps>
...
80106459:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
8010645e:	e9 7c f4 ff ff       	jmp    801058df <alltraps>
...
80106465:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
8010646a:	e9 70 f4 ff ff       	jmp    801058df <alltraps>
...
80106471:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80106476:	e9 64 f4 ff ff       	jmp    801058df <alltraps>
...
8010647d:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80106482:	e9 58 f4 ff ff       	jmp    801058df <alltraps>
...
80106489:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
8010648e:	e9 4c f4 ff ff       	jmp    801058df <alltraps>
...
80106495:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
8010649a:	e9 40 f4 ff ff       	jmp    801058df <alltraps>
...
801064a1:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
801064a6:	e9 34 f4 ff ff       	jmp    801058df <alltraps>
...
801064ad:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
801064b2:	e9 28 f4 ff ff       	jmp    801058df <alltraps>
...
801064b9:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
801064be:	e9 1c f4 ff ff       	jmp    801058df <alltraps>
...
801064c5:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
801064ca:	e9 10 f4 ff ff       	jmp    801058df <alltraps>
...
801064d1:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
801064d6:	e9 04 f4 ff ff       	jmp    801058df <alltraps>
...
801064dd:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
801064e2:	e9 f8 f3 ff ff       	jmp    801058df <alltraps>
...
801064e9:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
801064ee:	e9 ec f3 ff ff       	jmp    801058df <alltraps>
...
801064f5:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
801064fa:	e9 e0 f3 ff ff       	jmp    801058df <alltraps>
...
80106501:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
80106506:	e9 d4 f3 ff ff       	jmp    801058df <alltraps>
...
8010650d:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
80106512:	e9 c8 f3 ff ff       	jmp    801058df <alltraps>
...
80106519:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
8010651e:	e9 bc f3 ff ff       	jmp    801058df <alltraps>
...
80106525:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
8010652a:	e9 b0 f3 ff ff       	jmp    801058df <alltraps>
...
80106531:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
80106536:	e9 a4 f3 ff ff       	jmp    801058df <alltraps>
...
8010653d:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80106542:	e9 98 f3 ff ff       	jmp    801058df <alltraps>
...
80106549:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
8010654e:	e9 8c f3 ff ff       	jmp    801058df <alltraps>
...
80106555:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
8010655a:	e9 80 f3 ff ff       	jmp    801058df <alltraps>
...
80106561:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80106566:	e9 74 f3 ff ff       	jmp    801058df <alltraps>
...
8010656d:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80106572:	e9 68 f3 ff ff       	jmp    801058df <alltraps>
...
80106579:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
8010657e:	e9 5c f3 ff ff       	jmp    801058df <alltraps>
...
80106585:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
8010658a:	e9 50 f3 ff ff       	jmp    801058df <alltraps>
...
80106591:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80106596:	e9 44 f3 ff ff       	jmp    801058df <alltraps>
...
8010659d:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
801065a2:	e9 38 f3 ff ff       	jmp    801058df <alltraps>
...
801065a9:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
801065ae:	e9 2c f3 ff ff       	jmp    801058df <alltraps>
...
801065b5:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
801065ba:	e9 20 f3 ff ff       	jmp    801058df <alltraps>
...
801065c1:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
801065c6:	e9 14 f3 ff ff       	jmp    801058df <alltraps>
...
801065cd:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
801065d2:	e9 08 f3 ff ff       	jmp    801058df <alltraps>
...
801065d9:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
801065de:	e9 fc f2 ff ff       	jmp    801058df <alltraps>
...
801065e5:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
801065ea:	e9 f0 f2 ff ff       	jmp    801058df <alltraps>
...
801065f1:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
801065f6:	e9 e4 f2 ff ff       	jmp    801058df <alltraps>
...
801065fd:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80106602:	e9 d8 f2 ff ff       	jmp    801058df <alltraps>
...
80106609:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
8010660e:	e9 cc f2 ff ff       	jmp    801058df <alltraps>
...
80106615:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
8010661a:	e9 c0 f2 ff ff       	jmp    801058df <alltraps>
...
80106621:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
80106626:	e9 b4 f2 ff ff       	jmp    801058df <alltraps>
...
8010662d:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80106632:	e9 a8 f2 ff ff       	jmp    801058df <alltraps>
...
80106639:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
8010663e:	e9 9c f2 ff ff       	jmp    801058df <alltraps>
...
80106645:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
8010664a:	e9 90 f2 ff ff       	jmp    801058df <alltraps>
...
80106651:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
80106656:	e9 84 f2 ff ff       	jmp    801058df <alltraps>
...
8010665d:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80106662:	e9 78 f2 ff ff       	jmp    801058df <alltraps>
...
80106669:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
8010666e:	e9 6c f2 ff ff       	jmp    801058df <alltraps>
...
80106675:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
8010667a:	e9 60 f2 ff ff       	jmp    801058df <alltraps>
...
80106681:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80106686:	e9 54 f2 ff ff       	jmp    801058df <alltraps>
...
8010668d:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80106692:	e9 48 f2 ff ff       	jmp    801058df <alltraps>
...
80106699:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
8010669e:	e9 3c f2 ff ff       	jmp    801058df <alltraps>
...
801066a5:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
801066aa:	e9 30 f2 ff ff       	jmp    801058df <alltraps>
...
801066b1:	68 de 00 00 00       	push   $0xde
  jmp alltraps
801066b6:	e9 24 f2 ff ff       	jmp    801058df <alltraps>
...
801066bd:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
801066c2:	e9 18 f2 ff ff       	jmp    801058df <alltraps>
...
801066c9:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
801066ce:	e9 0c f2 ff ff       	jmp    801058df <alltraps>
...
801066d5:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
801066da:	e9 00 f2 ff ff       	jmp    801058df <alltraps>
...
801066e1:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
801066e6:	e9 f4 f1 ff ff       	jmp    801058df <alltraps>
...
801066ed:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
801066f2:	e9 e8 f1 ff ff       	jmp    801058df <alltraps>
...
801066f9:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
801066fe:	e9 dc f1 ff ff       	jmp    801058df <alltraps>
...
80106705:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
8010670a:	e9 d0 f1 ff ff       	jmp    801058df <alltraps>
...
80106711:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80106716:	e9 c4 f1 ff ff       	jmp    801058df <alltraps>
...
8010671d:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80106722:	e9 b8 f1 ff ff       	jmp    801058df <alltraps>
...
80106729:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
8010672e:	e9 ac f1 ff ff       	jmp    801058df <alltraps>
...
80106735:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
8010673a:	e9 a0 f1 ff ff       	jmp    801058df <alltraps>
...
80106741:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80106746:	e9 94 f1 ff ff       	jmp    801058df <alltraps>
...
8010674d:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80106752:	e9 88 f1 ff ff       	jmp    801058df <alltraps>
...
80106759:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
8010675e:	e9 7c f1 ff ff       	jmp    801058df <alltraps>
...
80106765:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
8010676a:	e9 70 f1 ff ff       	jmp    801058df <alltraps>
...
80106771:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80106776:	e9 64 f1 ff ff       	jmp    801058df <alltraps>
...
8010677d:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80106782:	e9 58 f1 ff ff       	jmp    801058df <alltraps>
...
80106789:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
8010678e:	e9 4c f1 ff ff       	jmp    801058df <alltraps>
...
80106795:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
8010679a:	e9 40 f1 ff ff       	jmp    801058df <alltraps>
...
801067a1:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
801067a6:	e9 34 f1 ff ff       	jmp    801058df <alltraps>
...
801067ad:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
801067b2:	e9 28 f1 ff ff       	jmp    801058df <alltraps>
...
801067b9:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
801067be:	e9 1c f1 ff ff       	jmp    801058df <alltraps>
...
801067c5:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
801067ca:	e9 10 f1 ff ff       	jmp    801058df <alltraps>
...
801067d1:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
801067d6:	e9 04 f1 ff ff       	jmp    801058df <alltraps>
...
801067dd:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
801067e2:	e9 f8 f0 ff ff       	jmp    801058df <alltraps>
...
801067e9:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
801067ee:	e9 ec f0 ff ff       	jmp    801058df <alltraps>
...
801067f5:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
801067fa:	e9 e0 f0 ff ff       	jmp    801058df <alltraps>
...
80106801:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80106806:	e9 d4 f0 ff ff       	jmp    801058df <alltraps>
...
8010680d:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80106812:	e9 c8 f0 ff ff       	jmp    801058df <alltraps>
...
80106819:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
8010681e:	e9 bc f0 ff ff       	jmp    801058df <alltraps>
...
80106825:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
8010682a:	e9 b0 f0 ff ff       	jmp    801058df <alltraps>
...
80106831:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80106836:	e9 a4 f0 ff ff       	jmp    801058df <alltraps>
...
8010683d:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80106842:	e9 98 f0 ff ff       	jmp    801058df <alltraps>
...
80106995:	e8 c6 dc ff ff       	call   80104660 <memset>
...
801069dd:	68 e4 7d 10 80       	push   $0x80107de4
...
80106ab4:	0f 84 c2 00 00 00    	je     80106b7c <switchuvm+0xec>
  pushcli();
80106aba:	e8 91 d9 ff ff       	call   80104450 <pushcli>
...
80106bcf:	e8 8c da ff ff       	call   80104660 <memset>
...
80106c02:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106c03:	e9 f8 da ff ff       	jmp    80104700 <memmove>
    panic("inituvm: more than a page");
80106c08:	83 ec 0c             	sub    $0xc,%esp
80106c0b:	68 29 7e 10 80       	push   $0x80107e29
...
80106c70:	68 43 7e 10 80       	push   $0x80107e43
...
80106cf8:	68 e4 7e 10 80       	push   $0x80107ee4
...
80106d99:	68 61 7e 10 80       	push   $0x80107e61
...
80106dfb:	68 79 7e 10 80       	push   $0x80107e79
...
80106edc:	68 95 7e 10 80       	push   $0x80107e95
...
80106fac:	68 a6 7e 10 80       	push   $0x80107ea6
...
80107022:	68 b0 7e 10 80       	push   $0x80107eb0
...
80107080:	e8 7b d6 ff ff       	call   80104700 <memmove>
...
801070f7:	68 ca 7e 10 80       	push   $0x80107eca
