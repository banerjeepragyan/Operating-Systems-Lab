...
main(void)
{
  ...
  16:	68 60 0a 00 00       	push   $0xa60
  1b:	e8 23 03 00 00       	call   343 <draw>
  20:	83 c4 0c             	add    $0xc,%esp
  23:	50                   	push   %eax
  24:	68 28 07 00 00       	push   $0x728
  29:	6a 01                	push   $0x1
  2b:	e8 d0 03 00 00       	call   400 <printf>

	printf(1,"%s",buf);
  30:	83 c4 0c             	add    $0xc,%esp
  33:	68 60 0a 00 00       	push   $0xa60
  38:	68 44 07 00 00       	push   $0x744
  3d:	6a 01                	push   $0x1
 ...
 409:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 587:	90                   	nop
          s = "(null)";
 588:	ba 47 07 00 00       	mov    $0x747,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 5a1:	a1 30 12 00 00       	mov    0x1230,%eax
{
 ...
 5e1:	5b                   	pop    %ebx
  freep = p;
 5e2:	89 15 30 12 00 00    	mov    %edx,0x1230
}
 5e8:	5e                   	pop    %esi
 5e9:	5f                   	pop    %edi
 5ea:	5d                   	pop    %ebp
 ...
 619:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 61c:	89 15 30 12 00 00    	mov    %edx,0x1230
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 639:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 63c:	8b 3d 30 12 00 00    	mov    0x1230,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 67f:	73 4f                	jae    6d0 <malloc+0xa0>
    ...
    if(p == freep)
 681:	8b 3d 30 12 00 00    	mov    0x1230,%edi
 ...
 6aa:	e8 f1 fe ff ff       	call   5a0 <free>
  return freep;
 6af:	8b 15 30 12 00 00    	mov    0x1230,%edx
 ...
 6dc:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 6df:	89 15 30 12 00 00    	mov    %edx,0x1230
}
 ...
 6ef:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 6f0:	c7 05 30 12 00 00 34 	movl   $0x1234,0x1230
 6f7:	12 00 00 
    base.s.size = 0;
 6fa:	bf 34 12 00 00       	mov    $0x1234,%edi
    base.s.ptr = freep = prevp = &base;
 6ff:	c7 05 34 12 00 00 34 	movl   $0x1234,0x1234
 706:	12 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 709:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 70b:	c7 05 38 12 00 00 00 	movl   $0x0,0x1238
 712:	00 00 00 
    if(p->s.size >= nunits){
